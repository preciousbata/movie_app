...
void init() {
  ...
  //bloc
  sl.registerLazySingleton(() => TopRatedMovieBloc(getTopRatedMovieUseCase: sl.get()));
  sl.registerLazySingleton(() => TrendingMovieBloc(getTrendingMovieUseCase: sl.get()));
  sl.registerLazySingleton(() => TrendingTvShowBloc(getTrendingTvShowUseCase:sl.get()));
